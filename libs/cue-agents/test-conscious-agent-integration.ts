...
import { ConsciousAgent, DomainBase, DecisionContext } from './conscious-agent';
...
const smartThermostatDomain = agent.createSpecializedDomain(
  'smart_thermostat_control',
  ['thermostat', 'schedule', 'learning', 'prediction', 'user_pattern'],
  'engineering',
  0.4
);
...
const integrationScore = (
  (finalAgentStats.confidence) * 0.25 +
