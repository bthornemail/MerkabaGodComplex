...
export abstract class BaseStore implements iStore { 
    ...
    protected contexts: STORE_CONTEXT[];
...
export abstract class StoreStore extends BaseStore {
    constructor(rootContext: STORE_CONTEXT, history?: STORE) {
        super();
        this.extendedKey = rootContext.extendedKey;
        this.contexts = history ? history.contexts : [rootContext];
    }
...
export default class Store extends StoreStore {
    constructor(rootNode: STORE_CONTEXT, history?: STORE) {
