...
import { iRegisterEvents } from "../marketplace/event.register";
...
export type MESSAGES = Set<CONTENT>;
export type CHANNEL = {
    link: LINK;
}

export abstract class BaseChannel extends EventRegister implements iPublish, iSubscribe, iRegisterEvents {
    abstract link: LINK;
