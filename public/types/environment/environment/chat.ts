...
import readFilesInSubdirectorySync from "../../../../bin/commands/readFilesInSubdirectorySync";
...
export default async function chat(input: string, dir?: string) {
    ...
    try {
        ...
        const initMessages: Message[] = [
            { role: "system", content: readFilesInSubdirectorySync("./src") },
        ...
        // }
        const chatCompletion: any = await ollama.chat({
            // user: "chat_gpt",
            model: "gpt-4",
