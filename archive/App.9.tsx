...
const App: React.FC = () => {
  const [quadrantInputs, setQuadrantInputs] = useState<QuadrantState[]>([
    ...
    { id: 16, type: 'text', text: 'The user or agent initiating the interaction.', file: null, fileType: null, buffer: null, signature: null, fixedDimensionRay: null, ubhpType: 'Actor' },
    { id: 17, type: 'text', text: 'The specific action performed (e.g., "create", "update", "transfer").', file: null, fileType: null, buffer: null, signature: null, fixedDimensionRay: null, ubhpType: 'Action' },
    { id: 18, type: 'text', text: 'The resulting state or context after the transaction is complete.', file: null, fileType: null, buffer: null, signature: null, fixedDimensionRay: null, ubhpType: 'State' },
    { id: 19, type: 'text', text: 'The precise moment of the transaction, for chronological ordering.', file: null, fileType: null, buffer: null, signature: null, fixedDimensionRay: null, ubhpType: 'Timestamp' },
  ]);
  ...
  // Handler for deriving the 21D Universal Model Harmony (Updated to 28D)
