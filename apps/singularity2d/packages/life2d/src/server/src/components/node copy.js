...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  //         alert("dialing " + addr)
  //         console.log(await libp2p.dialProtocol(addr, '/vault_ai/0.1.0/chat/0.1.0'))
  ...
  //     //     console.log(await libp2p.dialProtocol(multiaddrs, '/vault_ai/0.1.0/chat/0.1.0'))
  //     //   } catch (error) {
  //     //     console.log(error)
  //     //   }
  //     // })
  ...
  //       console.log(await libp2p.dialProtocol(peerId, '/vault_ai/0.1.0/chat/0.1.0'))
  ...
  fetch('/multiaddr')
    .then(async (response) => {
      ...
      addrsBtn.addEventListener("click", async () => {
        ...
        // console.log(await libp2p.dialProtocol(MultiformatsMultiaddr.multiaddr("/ip4/172.18.0.1/tcp/35353/p2p/16Uiu2HAmVboqPtEibQihzkYNQq7gKjfbqPQFziqdU2xDv2ZEN7R3"), '/vault_ai/0.1.0/chat/0.1.0'))
      })
      multiaddrsEl.appendChild(addrsBtn)
    });
