...
const randomPortNumber = randomInt(0, randomPortLimit)
...
try {
  ...
  writeFileSync(__get_dirname(import.meta.url, '../data/wallet_' + randomPortNumber.toString() + '.json'), await wallet.encrypt('passwd84'))
}
