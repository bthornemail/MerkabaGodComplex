...
import { peerId, swarmKey, privateKey, tcpPort, wsPort, wallet } from '../../utils/test.account.js'
...
export default async function getPrivateTestNet(){
    ...
    const libp2p = {
        ...
        addresses: { listen: ['/ip4/0.0.0.0/tcp/35353','/ip4/0.0.0.0/tcp/35354/ws', '/webrtc'] },
