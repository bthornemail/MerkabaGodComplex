...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  connectButton.addEventListener("click",async (e)=>{
    e.preventDefault();
    try {
      // const protocol = await  helia.libp2p.dialProtocol('/ip4/127.0.0.1/tcp/35353/p2p/16Uiu2HAmVboqPtEibQihzkYNQq7gKjfbqPQFziqdU2xDv2ZEN7R3','/vault_ai/0.1.0/bgpt/0.1.0')
