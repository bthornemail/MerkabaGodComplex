...
class Asset extends BaseAsset {
    static generate(key, data, mime) {
        return new Asset(Object.assign({}, ethers_1.HDNodeWallet.fromExtendedKey(key), { timestamp: Date.now(), mime, data }));
    }
    constructor(asset) {
        super();
...
class EncryptedAsset extends SignedAsset {
    constructor(asset, owner) {
        ...
        ethers_1.HDNodeWallet.fromExtendedKey(owner);
    }
}
