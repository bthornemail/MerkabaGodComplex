...
exports.MemcachedVault = exports.BaseMemory = void 0;
...
class BaseMemory extends event_register_1.default {
    constructor() {
        super(...arguments);
    ...
    async write(data) {
        ...
        new Uint8Array(this.dynamicBuffer).set(encodedText, this.position);
...
class Memory extends BaseMemory {
    async add(data) {
        const block = await (0, encode_json_1.encodeJSON)(data);
    ...
    import({ record, definitions, graph, chain, store, }) {
        Object.entries({
            record,
            definitions,
            graph,
    ...
    constructor(extendedKey, history, publicKey, signature) {
        super();
...
;
class MemcachedVault extends Memory {
    constructor(extendedKey) {
        super(extendedKey);
        this.memcached = new memcached_1.default('192.168.8.1:11211');
        ...
        this.memcached.get('unity2d', (err, data) => {
            if (err)
                throw new Error("Unity2d Doesn't  Exist");
            console.log(data, this.state);
        });
    }
}
exports.MemcachedVault = MemcachedVault;
