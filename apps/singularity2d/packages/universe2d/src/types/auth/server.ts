...
app.listen(port, () => {
  ...
  wss.on('connection', function connection(ws) {
    async function onUser({ extendedKey, signature }: any) {
    ...
    async function onBlock({ extendedKey, root, hash, signature }: any) {
    ...
    async function onBlockContent({ extendedKey, root, hash, signature, content }: any) {
