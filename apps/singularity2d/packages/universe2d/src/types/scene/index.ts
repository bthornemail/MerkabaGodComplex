...
import createNetServer from '../../bin/create.net.server.js';
import createNetSocket from '../../bin/create.net.socket.js';
import { Block } from '../../../modules/blockchain/index.js';
...
export class Scene extends BaseScene {
    ...
    async initalize(phrase: string = "") {
        ...
        const {hash, signature} = new Block(content);
