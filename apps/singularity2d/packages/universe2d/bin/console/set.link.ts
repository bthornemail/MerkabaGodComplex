...
import { Content } from '../../types/marketplace/content.js';
const defaultParams = {
    "host": HostWallet.publicKey,
    "provider": ProviderWallet.publicKey
}
export default function setLink(signer?: HDNodeWallet | HDNodeVoidWallet | string, node?: Content & UrlWithStringQuery): string{
