...
const openGraphViewFormInput = document.querySelector("#open-graph-view-form-input");
const openGraphViewFormQtyButton = document.querySelector("#open-graph-view-form-qty-button");
