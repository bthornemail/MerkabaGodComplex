(function (global, factory) {
  ...
  /**
   * MultiGraph Internal Data Classes
   * =================================
   *
  ...
  /**
   * MultiGraph Node Attributes methods
   * ===================================
   */
  var NODE = 0;
  var SOURCE = 1;
  ...
  /**
   * MultiGraph Edge Attributes methods
   * ===================================
   */
  ...
  /**
   * MultiGraph Adjacency Iteration
   * ===============================
   *
   * Attaching some methods to the Graph class to be able to iterate over a
   * graph's adjacency.
  ...
  /**
   * MultiGraph Serialization Utilities
   * ===================================
   *
